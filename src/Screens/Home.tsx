...
function Home() {
  ...
  const locations = [
    ...
    },
    {
      ...
      dropPoints: [
        ...
        {
          name: "Paa Joe Round About",
          latitude: 6.678596454119355,
          longitude: -1.5709606375024159,
        },
        {
          name: "Hall 7",
          latitude: 6.679295619563862,
    ...
    },
    {
      ...
      dropPoints: [
        ...
        {
          name: "Commercial Area",
          latitude: 6.682756553904525,
          longitude: -1.576990347851461,
        },
        {
          name: "SRC Busstop",
          latitude: 6.675223889340042,
    ...
    },
    {
      ...
      dropPoints: [
        ...
        {
          name: "Paa Joe Round About",
          latitude: 6.675187511866504,
          longitude: -1.570775090040308,
        },
      ],
    },
    {
  ...
  const handleSearch = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (isSelectingDropOff && pickUp) {
      ...
      const validDropOffPoints = locations.filter(
        (location) =>
              ...
              style={{
                ...
                border:
                  selectedLocation?.id === location.id
                    ...
                    : "1px solid rgba(0,0,0,0.1)", // Highlight selected location
                display: "flex",
                padding: 12,
                alignItems: "center",
                gap: 16,
            ...
            >
              ...
              >
                <g clipPath="url(#clip0_629_5804)">
                  ...
                  <path
                    d="M12 18H14V20H12V18Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
                    d="M16 18H18V20H16V18Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path d="M8 23H10V25H8V23Z" fill="black" fillOpacity="0.6" />
                  <path
                    d="M12 23H14V25H12V23Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
                    d="M16 23H18V25H16V23Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
                    d="M23 13H25V15H23V13Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
                    d="M27 13H29V15H27V13Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
                    d="M23 18H25V20H23V18Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
                    d="M27 18H29V20H27V18Z"
                    fill="black"
                    fillOpacity="0.6"
                  />
                  <path
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <p
                  style={{ fontSize: 12, margin: 0, color: "rgba(0,0,0,0.6)" }}
                >
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 20, fontWeight: "700", margin: 0 }}>
            Welcome to KNUST <br />
            <span style={{ fontSize: 20, color: "#34A853", fontWeight: "400" }}>
              Shuttle
              <span style={{ fontWeight: "400", color: "#FFCE31" }}>App</span>
            </span>
          </p>
